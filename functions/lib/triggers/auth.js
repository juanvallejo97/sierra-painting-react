...
exports.getCurrentClaims = exports.assignUserRole = exports.setUserClaimsOnCreate = void 0;
 ...
 */
exports.setUserClaimsOnCreate = functions.auth.user().onCreate(async (user) => {
...
exports.assignUserRole = functions.https.onCall(async (data, context) => {
    ...
    if (!targetUserId || !role || !companyId) {
        throw new functions.https.HttpsError("invalid-argument", "targetUserId, role, and companyId are required");
    }
    ...
    if (callerClaims.companyId !== companyId) {
        ...
        throw new functions.https.HttpsError("permission-denied", "Cannot assign users to a different company");
    }
    try {
 ...
 * - Authentication required
 */
exports.getCurrentClaims = functions.https.onCall(async (data, context) => {
