 ...
 * Email Service
 *
 * Handles email sending via Firestore mail collection.
 * Compatible with Firebase Extension: Trigger Email from Firestore
 *
 * NOTE: Requires Firebase Extension "Trigger Email" to be installed
 * Extension listens to /mail/{docId} and sends emails via SendGrid/SMTP
 */
